...
<template>
  <div class="market-size-container">
    <j-module title="全国整体交易平台分析">
      <check-form :boxData="boxData1" @clickConfirm="clickConfirm" @handleData="handleData"></check-form>
    </j-module>
    <j-module>
      <template #title>
    ...
    <!-- <j-module>
      ...
      <j-trend :boxData="boxData2" ref="modelMethod"></j-trend>
    </j-module> -->
  </div>
</template>
<script>
...
import jTrend from './components/salesTrend'
  ...
  methods: {
    ...
    clickConfirm (val) {
      ...
      if (val.id === 1) {
        ...
        this.$refs.modelMethod.onConfirm(val)
      }
    }
  },
  components: {
